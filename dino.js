...
let cactus4Width = 115;
let cactus5Width = 136;
...
window.onload = function() {
    ...
    cactus4Img.src = "./img/big-cactus2.png";

    cactus5Img = new Image();
    cactus5Img.src = "./img/big-cactus3.png";
...
function placeCactus() {
    ...
    else if (placeCactusChance > .10) { //50% you get cactus1
